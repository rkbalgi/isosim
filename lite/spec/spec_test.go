...
func Test_FromJSON(t*testing.T) {
	...
	data := `[{"Id":28,"Value":"1100"},{"Id":29,"Value":"0111001000111100001001000000000100101000010000101000000000000000-"},{"Id":30,"Value":"375722658709239"},{"Id":31,"Value":"004000"},{"Id":32,"Value":"000000001000"},{"Id":35,"Value":"0421102451"},{"Id":36,"Value":"110602"},{"Id":37,"Value":"051018194312"},{"Id":38,"Value":"0503"},{"Id":39,"Value":"0901"},{"Id":44,"Value":"840"},{"Id":47,"Value":"261101101140"},{"Id":53,"Value":"0"},{"Id":55,"Value":"375722658709239D080810104013667200000"},{"Id":56,"Value":"000000000001"},{"Id":60,"Value":"5434501367     "},{"Id":62,"Value":"AXIAC21090101APN23FROST JANE M MRS       ABC  XYZ  RTG6110ABC  /DEF  /GHI  /JKL  /MNO  /PQR  /STU  /VWX  /YZA  /XYZ  ALC5509AB   /XY   /BC   /CD   /DE   /DE   / CD   /BC   /AB   ABC123DEF456GHI789JKL012001127.142.151.223CE 24CFFROST@EMAILADDRESS.COM"},{"Id":63,"Value":"840"}]`;

	spec := GetSpec(26)
	msg := spec.GetMessageById(27);
	parsedMsg,err:=msg.ParseJSON(data);
	if(err!=nil){
		t.Fatal(err.Error())
	}
	responseMsg := parsedMsg.Copy();
	iso := NewIso(responseMsg);
...
func ToJsonList(parsedMsg *ParsedMsg) []fieldIdValue {
	...
	for id, fieldData := range (parsedMsg.FieldDataMap) {
		...
		if (fieldData.Field.FieldInfo.Type == BITMAP) {
